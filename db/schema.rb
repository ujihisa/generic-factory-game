...
ActiveRecord::Schema[7.1].define(version: 2020_06_06_222711) do
  ...
  create_table "darklaunches", force: :cascade do |t|
    ...
    t.datetime "created_at", default: "2023-10-14 20:55:23", null: false
    t.datetime "updated_at", default: "2023-10-14 20:55:23", null: false
