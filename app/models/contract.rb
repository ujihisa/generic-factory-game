...
class Contract < Struct.new(:name, :mode, :required_credit, :description, :trades)
  ...
  ALL = {
    'Tutorial' => new('Tutorial Contract', 'tutorial', 0, 'Just a tutorial dummy contract', {
      default: Trade.new(100, 95), # Math.sqrt(18) * 6 = 25
    }),

    'A' => new('Contract A', 'easy', 0, 'They have a big sale in Nov.', {
      default: Trade.new(18, 28), # Math.sqrt(18) * 6 = 25
      November: Trade.new(38, 40), # Math.sqrt(38) * 6 = 37
    }),

    'B' => new('Contract B', 'easy', 0, 'Their business is constant', {
      default: Trade.new(56, 30), # Math.sqrt(56) * 6 = 45
    }),

    'C' => new('Contract C', 'easy', 0, 'Their business is constant', {
      default: Trade.new(100, 40), # Math.sqrt(100) * 6 = 60
    }),

    'D' => new('Contract D', 'easy', 15, 'They close business only in January', {
      default: Trade.new(10, 18), # Math.sqrt(10) * 6 = 19
      January: Trade.new(0, 0),
    }),

    'E' => new('Contract E', 'easy', 15, 'They have a sale in Dec.', {
      default: Trade.new(40, 37), # Math.sqrt(40) * 6 = 38
      December: Trade.new(80, 53), # Math.sqrt(80) * 6 = 54
    }),

    'F' => new('Contract F', 'easy', 15, 'They have a big sale in Dec.', {
      default: Trade.new(80, 53), # Math.sqrt(80) * 6 = 54
      December: Trade.new(100, 59), # Math.sqrt(100) * 6 = 60
    }),

    'G' => new('Contract G', 'easy', 30, 'They close business only in January', {
      default: Trade.new(20, 27), # Math.sqrt(20) * 6 = 27
      January: Trade.new(0, 0),
    }),

    'H' => new('Contract H', 'easy', 30, 'Their business is constant', {
      default: Trade.new(60, 46), # Math.sqrt(60) * 6 = 46
    }),

    'I' => new('Contract I', 'easy', 30, 'Their business is constant', {
      default: Trade.new(120, 66), # Math.sqrt(120) * 6 = 66
    }),

    'J' => new('Contract J', 'easy', 45, 'They only need twice a year', {
    ...
    # normal
    'NormalA' => new('Contract A', 'normal', 0, 'Their business is constant', {
      default: Trade.new(40, 40),
    }),

    'NormalB' => new('Contract B', 'normal', 0, 'They only make their best deals', {
      default: Trade.new(180, 40), # Math.sqrt(56) * 6 = 45
      December: Trade.new(190, 50), # Math.sqrt(56) * 6 = 45
    }),

    'NormalC' => new('Contract C', 'normal', 0, "They only make their best deals", {
      default: Trade.new(300, 50), # Math.sqrt(100) * 6 = 60
      December: Trade.new(380, 60), # Math.sqrt(100) * 6 = 60
    }),

    'NormalD' => new('Contract D', 'normal', 15, 'They close business only in January', {
      default: Trade.new(10, 17), # Math.sqrt(10) * 6 = 19
      January: Trade.new(0, 0),
    }),

    'NormalE' => new('Contract E', 'normal', 15, 'They have a sale in Dec.', {
      default: Trade.new(40, 33), # Math.sqrt(40) * 6 = 38
      December: Trade.new(80, 55), # Math.sqrt(80) * 6 = 54
    }),

    'NormalF' => new('Contract F', 'normal', 15, 'They have a big sale in Dec.', {
      default: Trade.new(200, 50),
      December: Trade.new(400, 100),
    }),

    'NormalG' => new('Contract G', 'normal', 20, 'They close business only in December', {
      default: Trade.new(60, 39),
      December: Trade.new(0, 0),
    }),

    'NormalH' => new('Contract H', 'normal', 25, 'They get busy in December', {
      default: Trade.new(140, 70),
      December: Trade.new(200, 90),
    }),

    'NormalI' => new('Contract I', 'normal', 30, 'Their business is constant', {
      default: Trade.new(18, 10),
    }),

    'NormalJ' => new('Contract J', 'normal', 50, 'They have big sales in Nov and Dec', {
      default: Trade.new(127, 43),
      November: Trade.new(187, 60), # Math.sqrt(200) * 6 = 85
      December: Trade.new(180, 60), # Math.sqrt(200) * 6 = 85
    }),

    'NormalK' => new('Contract K', 'normal', 55, 'Black Friday matters', {
      default: Trade.new(100, 31),
      November: Trade.new(220, 62),
    }),

    'NormalL' => new('Contract L', 'normal', 70, 'They close during summer', {
