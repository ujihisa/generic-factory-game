...
class Contract < Struct.new(:name, :mode, :required_credit, :description, :trades)
  ...
  ALL = {
    ...
    # normal
    'NormalA' => new(
      'Contract A', 'normal', 0, 'Their business is constant', {
        default: Trade.new(40, 40),
      }),

    'NormalB' => new(
      'Contract B', 'normal', 0, 'They only make their best deals', {
        default: Trade.new(180, 40), # Math.sqrt(56) * 6 = 45
        December: Trade.new(190, 50), # Math.sqrt(56) * 6 = 45
      }),

    'NormalC' => new(
      'Contract C', 'normal', 0, "They only make their best deals", {
        default: Trade.new(300, 50), # Math.sqrt(100) * 6 = 60
        December: Trade.new(380, 60), # Math.sqrt(100) * 6 = 60
      }),

    'NormalD' => new(
      'Contract D', 'normal', 15, 'They close business only in January', {
        default: Trade.new(10, 17), # Math.sqrt(10) * 6 = 19
        January: Trade.new(0, 0),
      }),

    'NormalE' => new(
      'Contract E', 'normal', 15, 'They have a sale in Dec.', {
        default: Trade.new(40, 33), # Math.sqrt(40) * 6 = 38
        December: Trade.new(80, 55), # Math.sqrt(80) * 6 = 54
      }),

    'NormalF' => new(
      'Contract F', 'normal', 15, 'They have a big sale in Dec.', {
        default: Trade.new(200, 50),
        December: Trade.new(400, 100),
      }),

    'NormalG' => new(
      'Contract G', 'normal', 20, 'They close business only in December', {
        default: Trade.new(60, 37),
        December: Trade.new(0, 0),
      }),

    'NormalH' => new(
      'Contract H', 'normal', 25, 'They get busy in December', {
        default: Trade.new(140, 70),
        December: Trade.new(200, 90),
      }),

    'NormalI' => new(
      'Contract I', 'normal', 30, 'Their business is constant', {
        default: Trade.new(18, 10),
      }),

    'NormalJ' => new(
      'Contract J', 'normal', 50, 'They have big sales in Nov and Dec', {
    ...
    'NormalK' => new(
      'Contract K', 'normal', 55, 'Black Friday matters', {
        default: Trade.new(100, 31),
        November: Trade.new(220, 62),
      }),

    'NormalL' => new(
      'Contract L', 'normal', 70, 'They close during summer', {
        default: Trade.new(500, 160),
        July: Trade.new(0, 0),
    ...
    'NormalM' => new(
      'City Project', 'normal', 80, 'For a public service', {
        default: Trade.new(1000, 400),
      }),
